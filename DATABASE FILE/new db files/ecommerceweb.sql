...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 12, 2025 at 06:09 PM
...
(5, 'Update', 'Update', 'Mettre à jour'),
(6, 'Read More', 'Read More', 'Lire la suite'),
(7, 'Serial', 'Serial', 'Numéro de série'),
(8, 'Photo', 'Photo', 'Photo'),
(9, 'Login', 'Login', 'Connexion'),
(10, 'Customer Login', 'Customer Login', 'Connexion client'),
(11, 'Click here to login', 'Click here to login', 'Cliquez ici pour vous connecter'),
(12, 'Back to Login Page', 'Back to Login Page', 'Retour à la page de connexion'),
(13, 'Logged in as', 'Logged in as', 'Connecté en tant que'),
(14, 'Logout', 'Logout', 'Déconnexion'),
(15, 'Register', 'Register', 'S\'inscrire'),
(16, 'Customer Registration', 'Customer Registration', 'Inscription client'),
(17, 'Registration Successful', 'Registration Successful', 'Inscription réussie'),
(18, 'Cart', 'Cart', 'Panier'),
(19, 'View Cart', 'View Cart', 'Voir le panier'),
(20, 'Update Cart', 'Update Cart', 'Mettre à jour le panier'),
(21, 'Back to Cart', 'Back to Cart', 'Retour au panier'),
(22, 'Checkout', 'Checkout', 'Paiement'),
(23, 'Proceed to Checkout', 'Proceed to Checkout', 'Procéder au paiement'),
(24, 'Orders', 'Orders', 'Commandes'),
(25, 'Order History', 'Order History', 'Historique des commandes'),
(26, 'Order Details', 'Order Details', 'Détails de la commande'),
(27, 'Payment Date and Time', 'Payment Date and Time', 'Date et heure du paiement'),
(28, 'Transaction ID', 'Transaction ID', 'ID de transaction'),
(29, 'Paid Amount', 'Paid Amount', 'Montant payé'),
(30, 'Payment Status', 'Payment Status', 'Statut du paiement'),
(31, 'Payment Method', 'Payment Method', 'Méthode de paiement'),
(32, 'Payment ID', 'Payment ID', 'ID de paiement'),
(33, 'Payment Section', 'Payment Section', 'Section de paiement'),
(34, 'Select Payment Method', 'Select Payment Method', 'Sélectionner la méthode de paiement'),
(35, 'Select a Method', 'Select a Method', 'Sélectionner une méthode'),
(36, 'PayPal', 'PayPal', 'PayPal'),
(37, 'Stripe', 'Stripe', 'Stripe'),
(38, 'Bank Deposit', 'Bank Deposit', 'Dépôt bancaire'),
(39, 'Card Number', 'Card Number', 'Numéro de carte'),
(40, 'CVV', 'CVV', 'CVV'),
(41, 'Month', 'Month', 'Mois'),
(42, 'Year', 'Year', 'Année'),
(43, 'Send to this Details', 'Send to this Details', 'Envoyer à ces coordonnées'),
(44, 'Transaction Information', 'Transaction Information', 'Informations sur la transaction'),
(45, 'Include transaction id and other information correctly', 'Include transaction id and other information correctly', 'Inclure correctement l\'ID de transaction et autres informations'),
(46, 'Pay Now', 'Pay Now', 'Payer maintenant'),
(47, 'Product Name', 'Product Name', 'Nom du produit'),
(48, 'Product Details', 'Product Details', 'Détails du produit'),
(49, 'Categories', 'Categories', 'Catégories'),
(50, 'Category:', 'Category:', 'Catégorie :'),
(51, 'All Products Under', 'All Products Under', 'Tous les produits sous'),
(52, 'Select Size', 'Select Size', 'Sélectionner la taille'),
(53, 'Select Color', 'Select Color', 'Sélectionner la couleur'),
(54, 'Product Price', 'Product Price', 'Prix du produit'),
(55, 'Quantity', 'Quantity', 'Quantité'),
(56, 'Out of Stock', 'Out of Stock', 'Rupture de stock'),
(57, 'Share This', 'Share This', 'Partager ceci'),
(58, 'Share This Product', 'Share This Product', 'Partager ce produit'),
(59, 'Product Description', 'Product Description', 'Description du produit'),
(60, 'Features', 'Features', 'Caractéristiques'),
(61, 'Conditions', 'Conditions', 'Conditions'),
(62, 'Return Policy', 'Return Policy', 'Politique de retour'),
(63, 'Reviews', 'Reviews', 'Avis'),
(64, 'Review', 'Review', 'Avis'),
(65, 'Give a Review', 'Give a Review', 'Donner un avis'),
(66, 'Write your comment (Optional)', 'Write your comment (Optional)', 'Écrivez votre commentaire (optionnel)'),
(67, 'Submit Review', 'Submit Review', 'Soumettre l\'avis'),
(68, 'You already have given a rating!', 'You already have given a rating!', 'Vous avez déjà donné une note !'),
(69, 'You must have to login to give a review', 'You must have to login to give a review', 'Vous devez vous connecter pour donner un avis'),
(70, 'No description found', 'No description found', 'Aucune description trouvée'),
(71, 'No feature found', 'No feature found', 'Aucune caractéristique trouvée'),
(72, 'No condition found', 'No condition found', 'Aucune condition trouvée'),
(73, 'No return policy found', 'No return policy found', 'Aucune politique de retour trouvée'),
(74, 'Review not found', 'Review not found', 'Avis non trouvé'),
(75, 'Customer Name', 'Customer Name', 'Nom du client'),
(76, 'Comment', 'Comment', 'Commentaire'),
(77, 'Comments', 'Comments', 'Commentaires'),
(78, 'Rating', 'Rating', 'Note'),
(79, 'Previous', 'Previous', 'Précédent'),
(80, 'Next', 'Next', 'Suivant'),
(81, 'Sub Total', 'Sub Total', 'Sous-total'),
(82, 'Total', 'Total', 'Total'),
(83, 'Action', 'Action', 'Action'),
(84, 'Shipping Cost', 'Shipping Cost', 'Frais de livraison'),
(85, 'Continue Shopping', 'Continue Shopping', 'Continuer vos achats'),
(86, 'Update Billing Address', 'Update Billing Address', 'Mettre à jour l\'adresse de facturation'),
(87, 'Update Shipping Address', 'Update Shipping Address', 'Mettre à jour l\'adresse de livraison'),
(88, 'Update Billing and Shipping Info', 'Update Billing and Shipping Info', 'Mettre à jour les informations de facturation et de livraison'),
(89, 'Dashboard', 'Dashboard', 'Tableau de bord'),
(90, 'Welcome to the Dashboard', 'Welcome to the Dashboard', 'Bienvenue sur le tableau de bord'),
(91, 'Back to Dashboard', 'Back to Dashboard', 'Retour au tableau de bord'),
(92, 'Subscribe', 'Subscribe', 'S\'abonner'),
(93, 'Subscribe To Our Newsletter', 'Subscribe To Our Newsletter', 'Abonnez-vous à notre newsletter'),
(94, 'Email Address', 'Email Address', 'Adresse e-mail'),
(95, 'Enter Your Email Address', 'Enter Your Email Address', 'Entrez votre adresse e-mail'),
(96, 'Password', 'Password', 'Mot de passe'),
(97, 'Forget Password', 'Forget Password', 'Mot de passe oublié'),
(98, 'Retype Password', 'Retype Password', 'Retapez le mot de passe'),
(99, 'Update Password', 'Update Password', 'Mettre à jour le mot de passe'),
(100, 'New Password', 'New Password', 'Nouveau mot de passe'),
(101, 'Retype New Password', 'Retype New Password', 'Retapez le nouveau mot de passe'),
(102, 'Full Name', 'Full Name', 'Nom complet'),
(103, 'Company Name', 'Company Name', 'Nom de l\'entreprise'),
(104, 'Phone Number', 'Phone Number', 'Numéro de téléphone'),
(105, 'Address', 'Address', 'Adresse'),
(106, 'Country', 'Country', 'Pays'),
(107, 'City', 'City', 'Ville'),
(108, 'State', 'State', 'État'),
(109, 'Zip Code', 'Zip Code', 'Code postal'),
(110, 'About Us', 'About Us', 'À propos de nous'),
(111, 'Featured Posts', 'Featured Posts', 'Articles en vedette'),
(112, 'Popular Posts', 'Popular Posts', 'Articles populaires'),
(113, 'Recent Posts', 'Recent Posts', 'Articles récents'),
(114, 'Contact Information', 'Contact Information', 'Informations de contact'),
(115, 'Contact Form', 'Contact Form', 'Formulaire de contact'),
(116, 'Our Office', 'Our Office', 'Notre bureau'),
(117, 'Update Profile', 'Update Profile', 'Mettre à jour le profil'),
(118, 'Send Message', 'Send Message', 'Envoyer le message'),
(119, 'Message', 'Message', 'Message'),
(120, 'Find Us On Map', 'Find Us On Map', 'Nous trouver sur la carte'),
(121, 'Congratulation! Payment is successful.', 'Congratulation! Payment is successful.', 'Félicitations ! Le paiement a réussi.'),
(122, 'Billing and Shipping Information is updated successfully.', 'Billing and Shipping Information is updated successfully.', 'Les informations de facturation et de livraison ont été mises à jour avec succès.'),
(123, 'Customer Name can not be empty.', 'Customer Name can not be empty.', 'Le nom du client ne peut pas être vide.'),
(124, 'Phone Number can not be empty.', 'Phone Number can not be empty.', 'Le numéro de téléphone ne peut pas être vide.'),
(125, 'Address can not be empty.', 'Address can not be empty.', 'L\'adresse ne peut pas être vide.'),
(126, 'You must have to select a country.', 'You must have to select a country.', 'Vous devez sélectionner un pays.'),
(127, 'City can not be empty.', 'City can not be empty.', 'La ville ne peut pas être vide.'),
(128, 'State can not be empty.', 'State can not be empty.', 'L\'état ne peut pas être vide.'),
(129, 'Zip Code can not be empty.', 'Zip Code can not be empty.', 'Le code postal ne peut pas être vide.'),
(130, 'Profile Information is updated successfully.', 'Profile Information is updated successfully.', 'Les informations du profil ont été mises à jour avec succès.'),
(131, 'Email Address can not be empty', 'Email Address can not be empty', 'L\'adresse e-mail ne peut pas être vide'),
(132, 'Email and/or Password can not be empty.', 'Email and/or Password can not be empty.', 'L\'e-mail et/ou le mot de passe ne peuvent pas être vides.'),
(133, 'Email Address does not match.', 'Email Address does not match.', 'L\'adresse e-mail ne correspond pas.'),
(134, 'Email address must be valid.', 'Email address must be valid.', 'L\'adresse e-mail doit être valide.'),
(135, 'You email address is not found in our system.', 'You email address is not found in our system.', 'Votre adresse e-mail n\'est pas trouvée dans notre système.'),
(136, 'Please check your email and confirm your subscription.', 'Please check your email and confirm your subscription.', 'Veuillez vérifier votre e-mail et confirmer votre abonnement.'),
(137, 'Your email is verified successfully. You can now login to our website.', 'Your email is verified successfully. You can now login to our website.', 'Votre e-mail a été vérifié avec succès. Vous pouvez maintenant vous connecter à notre site.'),
(138, 'Password can not be empty.', 'Password can not be empty.', 'Le mot de passe ne peut pas être vide.'),
(139, 'Passwords do not match.', 'Passwords do not match.', 'Les mots de passe ne correspondent pas.'),
(140, 'Please enter new and retype passwords.', 'Please enter new and retype passwords.', 'Veuillez entrer et retaper les nouveaux mots de passe.'),
(141, 'Password is updated successfully.', 'Password is updated successfully.', 'Le mot de passe a été mis à jour avec succès.'),
(142, 'To reset your password, please click on the link below.', 'To reset your password, please click on the link below.', 'Pour réinitialiser votre mot de passe, veuillez cliquer sur le lien ci-dessous.'),
(143, 'PASSWORD RESET REQUEST - YOUR WEBSITE.COM', 'PASSWORD RESET REQUEST - YOUR WEBSITE.COM', 'DEMANDE DE RÉINITIALISATION DU MOT DE PASSE - VOTRE SITE.COM'),
(144, 'The password reset email time (24 hours) has expired. Please again try to reset your password.', 'The password reset email time (24 hours) has expired. Please again try to reset your password.', 'Le délai de l\'e-mail de réinitialisation du mot de passe (24 heures) a expiré. Veuillez réessayer de réinitialiser votre mot de passe.'),
(145, 'A confirmation link is sent to your email address. You will get the password reset information in there.', 'A confirmation link is sent to your email address. You will get the password reset information in there.', 'Un lien de confirmation a été envoyé à votre adresse e-mail. Vous recevrez les informations de réinitialisation du mot de passe.'),
(146, 'Password is reset successfully. You can now login.', 'Password is reset successfully. You can now login.', 'Le mot de passe a été réinitialisé avec succès. Vous pouvez maintenant vous connecter.'),
(147, 'Email Address Already Exists', 'Email Address Already Exists.', 'L\'adresse e-mail existe déjà.'),
(148, 'Sorry! Your account is inactive. Please contact to the administrator.', 'Sorry! Your account is inactive. Please contact to the administrator.', 'Désolé ! Votre compte est inactif. Veuillez contacter l\'administrateur.'),
(149, 'Change Password', 'Change Password', 'Changer le mot de passe'),
(150, 'Registration Email Confirmation for YOUR WEBSITE', 'Registration Email Confirmation for YOUR WEBSITE.', 'Confirmation d\'inscription par e-mail pour VOTRE SITE.'),
(151, 'Thank you for your registration! Your account has been created. To active your account click on the link below:', 'Thank you for your registration! Your account has been created. To active your account click on the link below:', 'Merci pour votre inscription ! Votre compte a été créé. Pour l\'activer, cliquez sur le lien ci-dessous :'),
(152, 'Your registration is completed. Please check your email address to follow the process to confirm your registration.', 'Your registration is completed. Please check your email address to follow the process to confirm your registration.', 'Votre inscription est terminée. Veuillez vérifier votre adresse e-mail pour suivre le processus de confirmation.'),
(153, 'No Product Found', 'No Product Found', 'Aucun produit trouvé'),
(154, 'Add to Cart', 'Add to Cart', 'Ajouter au panier'),
(155, 'Related Products', 'Related Products', 'Produits associés'),
(156, 'See all related products from below', 'See all the related products from below', 'Voir tous les produits associés ci-dessous'),
(157, 'Size', 'Size', 'Taille'),
(158, 'Color', 'Color', 'Couleur'),
(159, 'Price', 'Price', 'Prix'),
(160, 'Please login as customer to checkout', 'Please login as customer to checkout', 'Veuillez vous connecter en tant que client pour payer'),
(161, 'Billing Address', 'Billing Address', 'Adresse de facturation'),
(162, 'Shipping Address', 'Shipping Address', 'Adresse de livraison'),
(163, 'Rating is Submitted Successfully!', 'Rating is Submitted Successfully!', 'La note a été soumise avec succès !');
...
CREATE TABLE `tbl_settings` (
  ...
  `featured_product_title` varchar(200) NOT NULL,
  `featured_product_subtitle` varchar(200) NOT NULL,
  `latest_product_title` varchar(200) NOT NULL,
  `latest_product_subtitle` varchar(200) NOT NULL,
  `popular_product_title` varchar(200) NOT NULL,
  `popular_product_subtitle` varchar(200) NOT NULL,
  `testimonial_title` varchar(200) NOT NULL,
  `testimonial_subtitle` varchar(200) NOT NULL,
  `testimonial_photo` varchar(150) NOT NULL,
  `blog_title` varchar(200) NOT NULL,
  `blog_subtitle` varchar(200) NOT NULL,
...
(1, 'slider-1.png', 'Welcome to REXBIKES', 'Shop Online for Latest Women Accessories', 'View Women Accessories', 'product-category.php?id=4&type=mid-category', 'Center'),
